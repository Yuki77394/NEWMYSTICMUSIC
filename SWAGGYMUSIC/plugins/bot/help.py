...
from SWAGGYMUSIC.help.buttons import BUTTONS
from SWAGGYMUSIC.help.helper import Helper
...
async def helper_cb(client, CallbackQuery):
    await CallbackQuery.edit_message_text(Helper.HELP_Swaggy, reply_markup=InlineKeyboardMarkup(BUTTONS.SBUTTON))
